...
% \center{
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width=\linewidth]{beta1_iter3.pdf}\\а)}
\end{minipage}
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width=\linewidth]{beta2_iter3.pdf}\\б)}
\end{minipage}
\center{
\begin{minipage}[h]{0.5\linewidth}
\center{\includegraphics[width=\linewidth]{temp_iter3.pdf}\\в)}
\end{minipage}}
\caption{График зависимости а)~$\lambda_1$; б)~$\lambda_2$; в) температуры от номера итерации}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.5\textwidth]{acc_18.pdf}
